...
const PaperStackCard = ({
  ...
  return (
    <div className={`group relative w-full ${className}`} {...props}>
      ...
      <div className="hidden lg:flex absolute inset-0 bg-olive-100 shadow-[0_4px_12px_rgba(0,0,0,0.03)] rounded-[1px] border-l border-olive-100 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] translate-x-6 translate-y-4 rotate-[2.5deg] group-hover:translate-x-0 group-hover:translate-y-0 group-hover:rotate-0">
        <div className="absolute inset-0 bg-paper-grain opacity-[0.03] mix-blend-multiply" />
      </div>

      {/* Layer 2 (Middle) */}
      <div className="absolute inset-0 bg-olive-50 shadow-[0_8px_20px_rgba(0,0,0,0.03)] rounded-[1px] border-l border-olive-100 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] translate-x-3 translate-y-1 rotate-[2.5deg] group-hover:translate-x-0 group-hover:translate-y-0 group-hover:rotate-0">
        <div className="absolute inset-0 bg-paper-grain opacity-[0.03] mix-blend-multiply" />
      </div>
