...
const SkillChip = React.memo(({ name }) => {
  ...
  return (
    <div
      className={`flex items-center gap-1 lg:gap-4 bg-white px-3 py-2 lg:px-4 lg:py-3.5 rounded-sm border border-dashed border-olive-400 ${styles.border} hover:border-solid shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:-translate-y-1 hover:shadow-md transition-all duration-300 ease-in-out mx-2 shrink-0 group cursor-default`}
    >
      <div
